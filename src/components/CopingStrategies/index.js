        ...
        <Container className="coping-strategies">
            ...
            <Box className="coping-strategies-section">
                ...
                <Typography variant="body1">
                    Exercise is a great way to relieve stress and anxiety. It
                    releases endorphins, which are natural mood boosters, and
                    can help you feel more relaxed and calm.
                </Typography>
                <Typography variant="body1">
            ...
            <div className="coping-strategies-section">
                ...
                <Typography variant="body1">
                    ...
                    the moment. It can help you focus on the present instead of
                    worrying about the future or ruminating on the past, which
            ...
            <div className="coping-strategies-section">
                ...
                <Typography variant="body1">
                    Connecting with others can help you feel supported and less
                    alone, which can reduce stress and anxiety. You can connect
                    with others in a variety of ways, such as:
                </Typography>
                <ul>
            ...
            <div className="coping-strategies-section">
                ...
                <Typography variant="body1">
                    Sleep is crucial for both physical and mental health.
                    Getting enough sleep can help you feel more rested and less
                    stressed, while not getting enough sleep can increase
                    feelings of anxiety.
                </Typography>
                <Typography variant="body1">
